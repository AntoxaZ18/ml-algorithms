...
-- CREATE FUNCTION city_trigger_ai() RETURNS trigger AS $city_trigger_ai$
--     BEGIN
--       UPDATE country SET last_update = DATETIME('NOW')  WHERE rowid = new.rowid;
--     END;
-- $city_trigger_ai$ LANGUAGE plpgsql;


-- CREATE TRIGGER city_trigger_ai AFTER INSERT ON city
--   EXECUTE PROCEDURE city_trigger_ai(); 
-- ;
...
-- CREATE FUNCTION address_trigger_ai() RETURNS trigger AS $address_trigger_ai$
--     BEGIN
--       UPDATE address SET last_update = DATETIME('NOW')  WHERE rowid = new.rowid;
--     END;
-- $address_trigger_ai$ LANGUAGE plpgsql;


-- CREATE TRIGGER address_trigger_ai AFTER INSERT ON address
--   EXECUTE PROCEDURE address_trigger_ai();
-- ;
...
-- CREATE FUNCTION language_trigger_ai() RETURNS trigger AS $language_trigger_ai$
--     BEGIN
--       UPDATE language SET last_update = DATETIME('NOW')  WHERE rowid = new.rowid;
--     END;
-- $language_trigger_ai$ LANGUAGE plpgsql;


-- CREATE TRIGGER language_trigger_ai AFTER INSERT ON language
--   EXECUTE PROCEDURE language_trigger_ai();
-- ;
